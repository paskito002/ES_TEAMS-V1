...
// Wipes a session's stored credentials so the next useMongoAuthState() call starts fresh --
// used when WhatsApp reports the session itself is corrupted/invalid (badSession) and
// reconnecting with the same creds would just fail the same way again.
